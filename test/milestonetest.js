...
bz.tier1='blackturtle'; bz.armor=0; bz.shieldXp=1; bz.shieldTurn=false; bz.tortoiseGuardTurns=0; G.TIER1.blackturtle.skill.f(bz); const tortoiseHp=bz.hp; G.hurtPlayer(9,'enemy',true); ok(bz.armor===0 && bz.shieldXp===1 && bz.tortoiseGuardTurns===3 && bz.hp===tortoiseHp-5 && bz.shieldTurn===false,'玄龟玄甲镇岳开启3回合全伤害减半');
