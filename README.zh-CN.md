...
| 🧑 人族 | 火法师 → 火墙 Firewall | 棋盘最下方 3 行形成火墙（红框提示）；其中怪物/Boss（含幽灵等，终焉之主除外）每回合掉**当前固定伤害的 10%**（最少 1 点） |
...
node submit-ai-until-posted.js           # 轮流尝试强势 build（默认精灵树人 / 矮人会长 / 人族骑士等），直到至少成功提交 1 条 AI 成绩，并轮询是否进入当前版本 AI 榜
```
