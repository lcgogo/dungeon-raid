...
| 🧌 Orc | 🪓 Axe Lord | Taunt | Set all enemies/bosses on the board (excluding the Overlord) to attack on the **next turn** by forcing their countdown to **1**; during that volley, **10% of the actual damage you take** becomes **permanent max HP** (**minimum +1**) |
