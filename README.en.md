...
The current Dev build is `v1.78.2`; lightened weapon and normal-monster tile backgrounds on Android to distinguish them from pink heart tiles. Bosses use a deterministic 30-card deck with two cards per boss and reshuffle when empty.
